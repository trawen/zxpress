(() => {
  ...
  var MilkdownError = class extends Error {
    constructor(code3, message, options) {
      ...
      this.code = code3;
      if ((options == null ? void 0 : options.cause) !== void 0) this.cause = options.cause;
    }
  };
  ...
  function createNodeInParserFail(nodeType, attrs, content3) {
    ...
    const messages = [
      ...
      ["[Attributes]", attrs],
      ["[Content]", (content3 != null ? content3 : []).map((node2) => {
  ...
  var Container = class {
    constructor() {
      ...
      this.get = (slice2) => {
        ...
        if (!context) {
          const name = typeof slice2 === "string" ? slice2 : slice2.name;
  ...
  var _meta, _container, _clock, _injectedSlices, _consumedSlices, _recordedTimers, _waitTimers, _getSlice, _getTimer, _a2;
  var Inspector = (_a2 = class {
  ...
  }, _meta = new WeakMap(), _container = new WeakMap(), _clock = new WeakMap(), _injectedSlices = new WeakMap(), _consumedSlices = new WeakMap(), _recordedTimers = new WeakMap(), _waitTimers = new WeakMap(), _getSlice = new WeakMap(), _getTimer = new WeakMap(), _a2);
  var _container2, _clock2, _meta2, _inspector, _a3;
  var Ctx = (_a3 = class {
    constructor(container, clock, meta) {
      ...
      this.produce = (meta2) => {
        if (meta2 && Object.keys(meta2).length) return new _a3(__privateGet(this, _container2), __privateGet(this, _clock2), { ...meta2 });
        return this;
      };
      this.inject = (sliceType, value) => {
        ...
        (_a11 = __privateGet(this, _inspector)) == null ? void 0 : _a11.onInject(sliceType);
        return this;
      };
      this.remove = (sliceType) => {
        var _a11;
        __privateGet(this, _container2).remove(sliceType);
        (_a11 = __privateGet(this, _inspector)) == null ? void 0 : _a11.onRemove(sliceType);
        return this;
      };
      this.record = (timerType) => {
        var _a11;
        timerType.create(__privateGet(this, _clock2).store);
        (_a11 = __privateGet(this, _inspector)) == null ? void 0 : _a11.onRecord(timerType);
        return this;
      };
      this.clearTimer = (timerType) => {
        var _a11;
        __privateGet(this, _clock2).remove(timerType);
        (_a11 = __privateGet(this, _inspector)) == null ? void 0 : _a11.onClear(timerType);
        return this;
      };
      ...
      this.use = (sliceType) => {
        var _a11;
        (_a11 = __privateGet(this, _inspector)) == null ? void 0 : _a11.onUse(sliceType);
      ...
      this.done = (timer) => {
        ...
        (_a11 = __privateGet(this, _inspector)) == null ? void 0 : _a11.onDone(timer);
      };
      this.wait = (timer) => {
        var _a11;
        const promise = this.timer(timer).start();
        (_a11 = __privateGet(this, _inspector)) == null ? void 0 : _a11.onWait(timer, promise);
        return promise;
      };
  ...
  }, _container2 = new WeakMap(), _clock2 = new WeakMap(), _meta2 = new WeakMap(), _inspector = new WeakMap(), _a3);
  var Clock = class {
    constructor() {
  ...
  var _promise, _listener, _eventUniqId, _status, _removeListener, _waitTimeout, _a4;
  var Timer = (_a4 = class {
    constructor(clock, type) {
      ...
      this.start = () => {
        var _a11;
        (_a11 = __privateGet(this, _promise)) != null ? _a11 : __privateSet(this, _promise, new Promise((resolve, reject) => {
  ...
  }, _promise = new WeakMap(), _listener = new WeakMap(), _eventUniqId = new WeakMap(), _status = new WeakMap(), _removeListener = new WeakMap(), _waitTimeout = new WeakMap(), _a4);
  var TimerType = class {
  ...
  function extname(path) {
    ...
    let unmatchedSlash;
    while (index2--) {
      const code3 = path.codePointAt(index2);
      if (code3 === 47) {
        if (unmatchedSlash) {
          startPart = index2 + 1;
          break;
  ...
  OrderedMap.prototype = {
    ...
    subtract: function(map5) {
      var result = this;
      map5 = OrderedMap.from(map5);
      for (var i2 = 0; i2 < map5.content.length; i2 += 2)
        result = result.remove(map5.content[i2]);
      return result;
    },
    // :: () → Object
  ...
  function insertInto(content3, dist, insert, openStart, openEnd, parent) {
    ...
    let inner = insertInto(child.content, dist - offset - 1, insert, index2 == 0 ? openStart - 1 : 0, index2 == content3.childCount - 1 ? openEnd - 1 : 0, child);
  ...
  function close(node2, content3) {
    if (!node2.type.validContent(content3))
  ...
  var Mapping = class _Mapping {
    ...
    */
    _map(pos, assoc, simple) {
      let delInfo = 0;
      for (let i2 = this.from; i2 < this.to; i2++) {
        let map5 = this._maps[i2], result = map5.mapResult(pos, assoc);
  ...
  function rangeHasCodeMark(state, from2, to) {
    if (from2 >= to) return false;
    let found2 = false;
    state.doc.nodesBetween(from2, to, (node2) => {
      if (node2.isInline && hasCodeMark(node2.marks)) found2 = true;
      return !found2;
    });
    return found2;
  }
  function typedCharInCodeSpan(state, pos) {
    var _a11;
    return hasCodeMark((_a11 = state.storedMarks) != null ? _a11 : state.doc.resolve(pos).marks());
  }
  function markRule(regexp, markType, options = {}) {
    return new InputRule(regexp, (state, match, start, end) => {
      ...
      const result = (_a11 = options.updateCaptured) == null ? void 0 : _a11.call(options, captured);
  ...
  var Stack = class {
    constructor() {
      ...
      this.push = (node2) => {
        var _a11;
        (_a11 = this.top()) == null ? void 0 : _a11.push(node2);
      };
      this.open = (node2) => {
  ...
  var _marks, _hasText, _maybeMerge, _matchTarget, _runNode, _closeNodeAndPush, _addNodeAndPush, _a5;
  var ParserState = (_a5 = class extends Stack {
    constructor(schema3) {
      super();
      ...
      this.addText = (text4) => {
        try {
          ...
          const currNode = this.schema.text(text4, __privateGet(this, _marks));
          if (!prevNode) {
  ...
  }, _marks = new WeakMap(), _hasText = new WeakMap(), _maybeMerge = new WeakMap(), _matchTarget = new WeakMap(), _runNode = new WeakMap(), _closeNodeAndPush = new WeakMap(), _addNodeAndPush = new WeakMap(), _a5.create = (schema3, remark) => {
    const state = new _a5(schema3);
    return (text4) => {
  ...
  var _a6;
  var SerializerStackElement = (_a6 = class extends StackElement {
    constructor(type, children, value, props = {}) {
      ...
      this.pop = () => {
        var _a11;
        return (_a11 = this.children) == null ? void 0 : _a11.pop();
      };
    }
  }, _a6.create = (type, children, value, props = {}) => new _a6(type, children, value, props), _a6);
  var isFragment = (x) => Object.prototype.hasOwnProperty.call(x, "size");
  var _openMarks, _matchTarget2, _runProseNode, _runProseMark, _orderMarks, _closeEndedMarks, _runNode2, _maybeMergeChildren, _createMarkdownNode, _moveSpaces, _closeNodeAndPush2, _addNodeAndPush2, _openMark, _closeMark, _a7;
  var SerializerState = (_a7 = class extends Stack {
    constructor(schema3) {
      super();
      ...
      __privateSet(this, _runProseNode, (node2) => {
        return __privateGet(this, _matchTarget2).call(this, node2).spec.toMarkdown.runner(this, node2);
      });
      __privateSet(this, _runProseMark, (mark, node2) => {
        return __privateGet(this, _matchTarget2).call(this, mark).spec.toMarkdown.runner(this, mark, node2);
      });
      __privateSet(this, _orderMarks, (marks) => {
        const getPriority = (x) => {
          var _a11;
          return (_a11 = x.type.spec.priority) != null ? _a11 : 50;
        };
        const rest = [...marks].sort((a, b) => getPriority(a) - getPriority(b));
        const continuing = [];
        __privateGet(this, _openMarks).forEach(({ mark }) => {
          const index2 = rest.findIndex((x) => x.eq(mark));
          if (index2 >= 0) continuing.push(...rest.splice(index2, 1));
        });
        return continuing.concat(rest);
      });
      __privateSet(this, _closeEndedMarks, (next) => {
        const nextMarks = next == null ? void 0 : next.marks;
        let keep = 0;
        while (keep < __privateGet(this, _openMarks).length) {
          const { mark, spanning } = __privateGet(this, _openMarks)[keep];
          if (spanning && (nextMarks == null ? void 0 : nextMarks.some((x) => x.eq(mark)))) keep++;
          else break;
        }
        for (let i2 = __privateGet(this, _openMarks).length - 1; i2 >= keep; i2--) __privateGet(this, _closeMark).call(this, __privateGet(this, _openMarks)[i2].mark);
      });
      __privateSet(this, _runNode2, (node2, next) => {
        if (__privateGet(this, _orderMarks).call(this, node2.marks).every((mark) => !__privateGet(this, _runProseMark).call(this, mark, node2))) __privateGet(this, _runProseNode).call(this, node2);
      ...
      __privateSet(this, _closeMark, (mark) => {
        let index2 = -1;
        for (let i2 = __privateGet(this, _openMarks).length - 1; i2 >= 0; i2--) if (__privateGet(this, _openMarks)[i2].mark.eq(mark)) {
          index2 = i2;
          break;
        }
        if (index2 < 0) return;
        __privateGet(this, _openMarks).splice(index2, 1);
      ...
      this.next = (nodes) => {
        if (isFragment(nodes)) {
          nodes.forEach((node2, _offset, index2) => {
            var _a11;
            __privateGet(this, _runNode2).call(this, node2, (_a11 = nodes.maybeChild(index2 + 1)) != null ? _a11 : void 0);
          });
          return this;
        }
    ...
    for (; ; ) {
      ...
      if (off == (dir < 0 ? 0 : nodeSize(node2))) {
        ...
        if (child.nodeType == 1 && child.contentEditable == "false") {
          if ((_a11 = child.pmViewDesc) === null || _a11 === void 0 ? void 0 : _a11.ignoreForSelection)
            off += dir;
          else
            return false;
        } else {
  ...
  var NodeViewDesc = class _NodeViewDesc extends ViewDesc {
    constructor(parent, node2, outerDeco, innerDeco, dom, contentDOM, nodeDOM) {
      super(parent, [], dom, contentDOM);
      this.node = node2;
    ...
    static create(parent, node2, outerDeco, innerDeco, view, pos) {
      ...
      if (spec)
        return descObj = new CustomNodeViewDesc(parent, node2, outerDeco, innerDeco, dom, contentDOM || null, nodeDOM, spec);
      else if (node2.isText)
        return new TextViewDesc(parent, node2, outerDeco, innerDeco, dom, nodeDOM);
      else
        return new _NodeViewDesc(parent, node2, outerDeco, innerDeco, dom, contentDOM || null, nodeDOM);
    }
    parseRule(addedNodes) {
  ...
  function docViewDesc(doc4, outerDeco, innerDeco, dom, view) {
    ...
    let docView = new NodeViewDesc(void 0, doc4, outerDeco, innerDeco, dom, dom, dom);
    if (docView.contentDOM)
      docView.updateChildren(view, 0);
    return docView;
  }
  var TextViewDesc = class _TextViewDesc extends NodeViewDesc {
    constructor(parent, node2, outerDeco, innerDeco, dom, nodeDOM) {
      super(parent, node2, outerDeco, innerDeco, dom, null, nodeDOM);
    }
    parseRule() {
    ...
    slice(from2, to, _view) {
      ...
      return new _TextViewDesc(this.parent, node2, this.outerDeco, this.innerDeco, dom, dom);
    }
    markDirty(from2, to) {
      super.markDirty(from2, to);
  ...
  var CustomNodeViewDesc = class extends NodeViewDesc {
    constructor(parent, node2, outerDeco, innerDeco, dom, contentDOM, nodeDOM, spec) {
      super(parent, node2, outerDeco, innerDeco, dom, contentDOM, nodeDOM);
      this.spec = spec;
    }
  ...
  function withWrappers(node2, wrap3, from2 = 0) {
    for (let i2 = wrap3.length - 1; i2 >= from2; i2--)
  ...
  function readHTML(html2) {
    ...
    let doc4 = detachedDoc(), elt = doc4.body;
  ...
  editHandlers.keypress = (view, _event) => {
    let event = _event;
    if (inOrNearComposition(view) || !event.charCode || event.ctrlKey && !event.altKey || mac5 && event.metaKey)
      return;
  ...
  function inOrNearComposition(view, event) {
    if (view.composing)
      return true;
    if (safari2 && Math.abs(Date.now() - view.input.compositionEndedAt) < 500) {
  ...
  handlers.beforeinput = (view, _event) => {
    let event = _event;
    if (android2 && event.inputType == "deleteContentBackward") {
  ...
  function fixUpBadSafariComposition(view, addedNodes) {
    ...
    for (let node2 of addedNodes) {
      if (((_a11 = node2.parentNode) === null || _a11 === void 0 ? void 0 : _a11.nodeName) == "TR") {
  ...
  function readDOMChange(view, from2, to, typeOver, addedNodes) {
    ...
    let sel = view.state.selection;
    let parse2 = parseBetween(view, from2, to, addedNodes);
  ...
  var EditorView = class {
    ...
    */
    ...
    updateStateInner(state, prevProps) {
      ...
      if (((_a11 = this.dragging) === null || _a11 === void 0 ? void 0 : _a11.node) && !prev.doc.eq(state.doc))
  ...
  function extendPriority(x) {
    ...
    return {
      ...x,
      parseDOM: (_a11 = x.parseDOM) == null ? void 0 : _a11.map((rule) => ({
        priority: x.priority,
        ...rule
      }))
    };
  ...
  var _container3, _ctx, _a8;
  var CommandManager = (_a8 = class {
    constructor() {
  ...
  }, _container3 = new WeakMap(), _ctx = new WeakMap(), _a8);
  ...
  var _ctx2, _keymap, _a9;
  var KeymapManager = (_a9 = class {
    constructor() {
      ...
      this.add = (keymap4) => {
        __privateGet(this, _keymap).push(keymap4);
        return () => {
          __privateSet(this, _keymap, __privateGet(this, _keymap).filter((item) => item !== keymap4));
        };
      };
      ...
      this.build = () => {
        ...
        return Object.fromEntries(Object.entries(keymap4).map(([key2, items]) => {
          const sortedItems = items.sort((a, b) => {
            var _a11, _b;
            return ((_a11 = b.priority) != null ? _a11 : 50) - ((_b = a.priority) != null ? _b : 50);
          });
          const command = (state, dispatch, view) => {
            const ctx = __privateGet(this, _ctx2);
            if (ctx == null) throw ctxCallOutOfScope();
            const commands3 = sortedItems.map((item) => item.onRun(ctx));
            return chainCommands(...commands3)(state, dispatch, view);
          };
          return [key2, command];
        }));
      };
  ...
  }, _ctx2 = new WeakMap(), _keymap = new WeakMap(), _a9);
    ...
    return async () => {
      ...
      ctx.update(prosePluginsCtx, (xs) => [new Plugin({
        ...
        view: (editorView2) => {
          ...
          handleDOM();
          return { destroy: () => {
            if (container == null ? void 0 : container.parentNode) container == null ? void 0 : container.parentNode.replaceChild(editorView2.dom, container);
      ...
      const view = new EditorView(el, {
        ...
        transformPasted: (slice2, view2, isPlainText) => {
          ctx.get(pasteRulesCtx).sort((a, b) => {
            var _a11, _b;
            return ((_a11 = b.priority) != null ? _a11 : 50) - ((_b = a.priority) != null ? _b : 50);
          }).map((rule) => rule.run).forEach((runner) => {
  ...
  var _enableInspector, _status2, _configureList, _onStatusChange, _container4, _clock3, _usrPluginStore, _sysPluginStore, _ctx3, _loadInternal, _prepare, _cleanup, _cleanupInternal, _setStatus, _loadPluginInStore, _a10;
  var Editor = (_a10 = class {
    constructor() {
      ...
      __privateSet(this, _cleanup, (plugins2, remove = false) => {
        return Promise.all([plugins2].flat().map(async (plugin) => {
          var _a11;
          const cleanup = (_a11 = __privateGet(this, _usrPluginStore).get(plugin)) == null ? void 0 : _a11.cleanup;
          if (remove) __privateGet(this, _usrPluginStore).delete(plugin);
          else __privateGet(this, _usrPluginStore).set(plugin, {
            ctx: void 0,
            handler: void 0,
            cleanup: void 0
          });
      ...
      this.use = (plugins2) => {
        ...
        if (__privateGet(this, _status2) === "Created") __privateGet(this, _prepare).call(this, _plugins, __privateGet(this, _usrPluginStore));
        return this;
      };
      ...
      this.destroy = async (clearPlugins = false) => {
        if (__privateGet(this, _status2) === "Destroyed" || __privateGet(this, _status2) === "OnDestroy") return this;
        if (__privateGet(this, _status2) === "OnCreate") return new Promise((resolve) => {
          setTimeout(() => {
      ...
      this.inspect = () => {
        ...
        return [...__privateGet(this, _sysPluginStore).values(), ...__privateGet(this, _usrPluginStore).values()].map(({ ctx }) => {
          var _a11;
          return (_a11 = ctx == null ? void 0 : ctx.inspector) == null ? void 0 : _a11.read();
        }).filter((x) => Boolean(x));
      };
    }
    static make() {
  ...
  function upsertById(list4, id, entry) {
    const idx = list4.findIndex(([x]) => x === id);
    if (idx === -1) return [...list4, entry];
    const next = list4.slice();
    next[idx] = entry;
    return next;
  }
  ...
  function $useKeymap(name, userKeymap) {
    const keymapDef = $ctx(Object.fromEntries(Object.entries(userKeymap).map(([key2, { shortcuts: shortcuts2, priority }]) => {
      return [key2, {
  ...
  function callCommand(slice2, payload) {
    return (ctx) => {
      return ctx.get(commandsCtx).call(slice2, payload);
    };
  }
  ...
  function serializeText(state, node2) {
    var _a11;
    if (!(node2.childCount >= 1 && ((_a11 = node2.lastChild) == null ? void 0 : _a11.type.name) === "hardbreak")) {
  ...
  var toggleInlineCodeCommand = $command("ToggleInlineCode", (ctx) => () => (state, dispatch) => {
    ...
    if (state.doc.rangeHasMark(from2, to, inlineCodeSchema.type(ctx))) {
      dispatch == null ? void 0 : dispatch(tr.removeMark(from2, to, inlineCodeSchema.type(ctx)));
      return true;
    }
    ...
    dispatch == null ? void 0 : dispatch(tr.addMark(from2, to, inlineCodeSchema.type(ctx).create()));
    return true;
  });
  ...
  function isIgnoredChar(code3) {
    return code3 <= 32 || code3 >= 127 && code3 <= 160 || code3 >= 8203 && code3 <= 8205 || code3 === 8232 || code3 === 8233 || code3 === 65279;
  }
  function stripIgnoredChars(input) {
    var _a11;
    let out = "";
    for (const char of input) if (!isIgnoredChar((_a11 = char.codePointAt(0)) != null ? _a11 : 0)) out += char;
    return out;
  }
  function sanitizeLinkHref(href) {
    ...
    const scheme = (_a11 = /^([a-z][a-z0-9+.-]*):/i.exec(normalized)) == null ? void 0 : _a11[1];
  ...
  function visitEmptyLine(ast) {
    return visitParents(ast, (node2) => {
      var _a11;
      return node2.type === "html" && [
        "<br />",
        "<br>",
        "<br >",
        "<br/>"
      ].includes((_a11 = node2.value) == null ? void 0 : _a11.trim());
    }, (node2, parents) => {
  ...
  var paragraphSchema = $nodeSchema("paragraph", (ctx) => ({
    ...
    toMarkdown: {
      ...
      runner: (state, node2) => {
        var _a11;
        const lastNode = (_a11 = ctx.get(editorViewCtx).state) == null ? void 0 : _a11.doc.lastChild;
  ...
  var wrapInHeadingInputRule = $inputRule((ctx) => {
    return textblockTypeInputRule(/^(?<hashes>#+)\s$/, headingSchema.type(ctx), (match) => {
      var _a11, _b;
      const x = ((_b = (_a11 = match.groups) == null ? void 0 : _a11.hashes) == null ? void 0 : _b.length) || 0;
  ...
  var downgradeHeadingCommand = $command("DowngradeHeading", (ctx) => () => (state, dispatch, view) => {
    ...
    dispatch == null ? void 0 : dispatch(state.tr.setNodeMarkup(state.selection.$from.before(), void 0, {
      ...node2.attrs,
      level
    }));
    return true;
  ...
  var codeBlockSchema = $nodeSchema("code_block", (ctx) => {
    return {
      ...
      parseMarkdown: {
        ...
        runner: (state, node2, type) => {
          var _a11;
          const language = (_a11 = node2.lang) != null ? _a11 : "";
          const value = node2.value;
      ...
      toMarkdown: {
        ...
        runner: (state, node2) => {
          var _a11;
          state.addNode("code", void 0, ((_a11 = node2.content.firstChild) == null ? void 0 : _a11.text) || "", { lang: node2.attrs.language });
        }
      }
    };
  });
  ...
  var createCodeBlockInputRule = $inputRule((ctx) => textblockTypeInputRule(/^```(?<language>[a-z]*)?[\s\n]$/, codeBlockSchema.type(ctx), (match) => {
    var _a11, _b;
    return { language: (_b = (_a11 = match.groups) == null ? void 0 : _a11.language) != null ? _b : "" };
  }));
  ...
  var updateImageCommand = $command("UpdateImage", (ctx) => (payload = {}) => (state, dispatch) => {
    ...
    dispatch == null ? void 0 : dispatch(state.tr.setNodeMarkup(pos, void 0, newAttrs).scrollIntoView());
    return true;
  });
  ...
  var hardbreakSchema = $nodeSchema("hardbreak", (ctx) => ({
    ...
    parseMarkdown: {
      ...
      runner: (state, node2, type) => {
        var _a11;
        state.addNode(type, { isInline: Boolean((_a11 = node2.data) == null ? void 0 : _a11.isInline) });
      }
    },
    leafText: () => "\n",
    toMarkdown: {
  ...
  var insertHardbreakCommand = $command("InsertHardbreak", (ctx) => () => (state, dispatch) => {
    ...
    if (selection.empty) {
      ...
      if (node2.childCount > 0 && ((_a11 = node2.lastChild) == null ? void 0 : _a11.type.name) === "hardbreak") {
    ...
    dispatch == null ? void 0 : dispatch(tr.setMeta("hardbreak", true).replaceSelectionWith(hardbreakSchema.type(ctx).create()).scrollIntoView());
    return true;
  });
  ...
  var bulletListSchema = $nodeSchema("bullet_list", (ctx) => {
    return {
      ...
      parseMarkdown: {
        ...
        runner: (state, node2, type) => {
          var _a11;
          const spread = (_a11 = node2.spread) != null ? _a11 : false;
  ...
  var orderedListSchema = $nodeSchema("ordered_list", (ctx) => ({
    ...
    parseMarkdown: {
      ...
      runner: (state, node2, type) => {
        var _a11, _b;
        const spread = (_a11 = node2.spread) != null ? _a11 : true;
        state.openNode(type, {
          spread,
          order: (_b = node2.start) != null ? _b : 1
    ...
    toMarkdown: {
      ...
      runner: (state, node2) => {
        ...
        state.openNode("list", void 0, {
          ordered: true,
          start: (_a11 = node2.attrs.order) != null ? _a11 : 1,
          spread: node2.attrs.spread
        });
        state.next(node2.content);
        state.closeNode();
  ...
  var htmlSchema = $nodeSchema("html", (ctx) => {
    return {
      ...
      parseDOM: [{
        ...
        getAttrs: (dom) => {
          var _a11;
          return { value: (_a11 = dom.dataset.value) != null ? _a11 : "" };
        }
      }],
      parseMarkdown: {
  ...
  var remarkAddOrderInListPlugin = $remark("remarkAddOrderInList", () => () => (tree) => {
    visit(tree, "list", (node2) => {
      var _a11;
      if (node2.ordered) {
        const start = (_a11 = node2.start) != null ? _a11 : 1;
    ...
    const syncOrderLabel = (transactions, _oldState, newState) => {
      ...
      newState.doc.descendants((node2, pos, parent, index2) => {
        ...
        if (node2.type === bulletListType) {
          ...
          if (parent == null ? void 0 : parent.maybeChild(0)) changed = handleNodeItem(attrs, index2, (_a11 = parent == null ? void 0 : parent.attrs.order) != null ? _a11 : 1);
          if (changed) {
  ...
  // admin-activity-entry.js
  function serialize(editor, outEl) {
    editor.action((ctx) => {
      const view = ctx.get(editorViewCtx);
      const serializer2 = ctx.get(serializerCtx);
      outEl.value = serializer2(view.state.doc);
    });
  }
  function writeMarkdown(editor, outEl, markdown) {
    editor.action(replaceAll(markdown, true));
    outEl.value = markdown;
  }
  function runCommand(editor, command, payload) {
    editor.action((ctx) => {
  ...
  function mountToolbar(rootEl, editor) {
    const wrap3 = document.createElement("div");
    wrap3.className = "custom-activity-editor-wrap";
    const toolbar = document.createElement("div");
    toolbar.className = "custom-activity-toolbar";
    const buttons = [
      { label: "B", title: "\u0416\u0438\u0440\u043D\u044B\u0439", command: toggleStrongCommand },
      { label: "I", title: "\u041A\u0443\u0440\u0441\u0438\u0432", command: toggleEmphasisCommand },
      { label: "</>", title: "\u041A\u043E\u0434", command: toggleInlineCodeCommand },
      {
        label: "Link",
        title: "\u0421\u0441\u044B\u043B\u043A\u0430",
        ...
        onClick: () => {
          ...
          if (href) runCommand(editor, toggleLinkCommand, { href });
        }
      },
      { label: "H2", title: "\u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A", command: wrapInHeadingCommand, payload: 2 },
      { label: "\u2022", title: "\u041C\u0430\u0440\u043A\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u044B\u0439 \u0441\u043F\u0438\u0441\u043E\u043A", command: wrapInBulletListCommand },
      { label: "1.", title: "\u041D\u0443\u043C\u0435\u0440\u043E\u0432\u0430\u043D\u043D\u044B\u0439 \u0441\u043F\u0438\u0441\u043E\u043A", command: wrapInOrderedListCommand },
      { label: "\u201C", title: "\u0426\u0438\u0442\u0430\u0442\u0430", command: wrapInBlockquoteCommand },
      { label: "\u2014", title: "\u041B\u0438\u043D\u0438\u044F", command: insertHrCommand },
      { label: "\u21B6", title: "\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C", command: undoCommand },
      { label: "\u21B7", title: "\u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u044C", command: redoCommand }
    ];
    for (const item of buttons) {
      const btn = document.createElement("button");
      btn.type = "button";
      btn.className = "custom-activity-toolbar-btn";
      ...
      btn.addEventListener("click", () => {
        ...
        runCommand(editor, item.command, item.payload);
      });
      toolbar.appendChild(btn);
    }
    rootEl.parentNode.insertBefore(wrap3, rootEl);
    wrap3.appendChild(toolbar);
    wrap3.appendChild(rootEl);
  }
  async function createEditor(rootEl, markdown) {
    const editor = await Editor.make().config((ctx) => {
      ctx.set(rootCtx, rootEl);
      ctx.set(defaultValueCtx, markdown);
    }).use(commonmark).use(history2).create();
    mountToolbar(rootEl, editor);
    return editor;
  }
  function bindTranslateEn(editorRu, editorEn, hiddenRu, hiddenEn) {
    var _a11;
    const btn = document.getElementById("custom-activity-translate-en");
    const statusEl = document.getElementById("custom-activity-translate-status");
    const form = (_a11 = document.getElementById("custom-activity-editor-ru")) == null ? void 0 : _a11.closest("form");
    if (!btn || !form) return;
    function setStatus(text4, kind) {
      if (!statusEl) return;
      statusEl.textContent = text4 || "";
      statusEl.classList.remove("is-error", "is-ok");
      if (kind) statusEl.classList.add(kind);
    }
    btn.addEventListener("click", () => {
      var _a12, _b;
      serialize(editorRu, hiddenRu);
      const titleRu = String((_a12 = hiddenRu.value) != null ? _a12 : "").trim();
      if (titleRu === "") {
        setStatus("\u0421\u043D\u0430\u0447\u0430\u043B\u0430 \u0437\u0430\u043F\u043E\u043B\u043D\u0438\u0442\u0435 \u0442\u0435\u043A\u0441\u0442 RU", "is-error");
        return;
      }
      serialize(editorEn, hiddenEn);
      const titleEn = String((_b = hiddenEn.value) != null ? _b : "").trim();
      if (titleEn !== "" && !window.confirm("\u0417\u0430\u043C\u0435\u043D\u0438\u0442\u044C \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u044E\u0449\u0438\u0439 EN-\u0442\u0435\u043A\u0441\u0442 \u043F\u0435\u0440\u0435\u0432\u043E\u0434\u043E\u043C?")) {
        return;
      }
      const fd = new FormData(form);
      fd.set("title_ru", titleRu);
      const action = form.getAttribute("action") || window.location.pathname;
      const url = action + (action.indexOf("?") >= 0 ? "&" : "?") + "action=translate_en";
      btn.disabled = true;
      setStatus("\u041F\u0435\u0440\u0435\u0432\u043E\u0434\u2026", "");
      fetch(url, { method: "POST", body: fd, credentials: "same-origin" }).then((response) => response.json().then((body) => ({ okHttp: response.ok, body }))).then((result) => {
        var _a13;
        if (!result.body || !result.body.ok) {
          throw new Error(result.body && result.body.error || "\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0435\u0440\u0435\u0432\u043E\u0434\u0430");
        }
        const translated = String((_a13 = result.body.title_en) != null ? _a13 : "");
        writeMarkdown(editorEn, hiddenEn, translated);
        setStatus("\u0413\u043E\u0442\u043E\u0432\u043E", "is-ok");
      }).catch((error) => {
        setStatus(error && error.message ? error.message : "\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0435\u0440\u0435\u0432\u043E\u0434\u0430", "is-error");
      }).finally(() => {
        btn.disabled = false;
      });
    });
  ...
  async function initEditors() {
    var _a11, _b, _c;
    const hiddenRu = document.getElementById("custom-activity-title-ru");
    const hiddenEn = document.getElementById("custom-activity-title-en");
    const rootRu = document.getElementById("custom-activity-editor-ru");
    const rootEn = document.getElementById("custom-activity-editor-en");
    if (!hiddenRu || !hiddenEn || !rootRu || !rootEn) return;
    const editorRu = await createEditor(rootRu, String((_a11 = hiddenRu.value) != null ? _a11 : ""));
    const editorEn = await createEditor(rootEn, String((_b = hiddenEn.value) != null ? _b : ""));
    editorRu.action((ctx) => {
      ctx.get(editorViewCtx).focus();
    });
    bindTranslateEn(editorRu, editorEn, hiddenRu, hiddenEn);
    const form = (_c = document.getElementById("custom-activity-editor-ru")) == null ? void 0 : _c.closest("form");
    if (form) {
  ...
  function bootEditors() {
    initEditors().catch((e) => {
      console.error("[admin_activity_custom] Milkdown init failed", e);
    });
  }
