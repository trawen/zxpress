...
CREATE TABLE `articles` (
  ...
  `text_type` int NOT NULL DEFAULT '2' COMMENT '0=legacy,1=text_pre,2=html_pre,3=markdown (mirror of text_type_ru)',
  `text_type_ru` int NOT NULL DEFAULT '2' COMMENT '0=legacy,1=text_pre,2=html_pre,3=markdown',
  `text_type_en` int NOT NULL DEFAULT '2' COMMENT '0=legacy,1=text_pre,2=html_pre,3=markdown',
...
CREATE TABLE `files` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_files_press_issue` (`id_press`,`id_issue`)
